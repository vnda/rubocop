...
require_relative "lib/rubocop/olist/version"

Gem::Specification.new do |spec|
  spec.name          = "rubocop-olist"
  spec.version       = Rubocop::Olist::VERSION
  spec.authors       = ["Rafael Souza"]
  spec.email         = ["rafael.silveira@olist.com"]
  ...
  spec.metadata["source_code_uri"] = "https://gitlab.olist.com/vnda/rubocop-olist"
